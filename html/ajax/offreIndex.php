<?php
  /// Génération progressive des données
  // 1. Récupérer l'ensemble des données à propos des filtres
  // 2. Récupérer les données des offres filtrés pour établir un tri
  // 3. Récupérer les données triés pour l'affichage suivant la pagniation.
  // Toutes les données seront stockées dans tableau pour charger uniquement les données non-connus
